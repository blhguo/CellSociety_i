...
public class WatorXMLmaker extends XMLmaker{
	...
	public WatorXMLmaker(String file, String shape, int gx, int gy, int cx, int cy, double probFish, double probShark, int rtShark, int rtFish, int eShark, int geShark) throws FileNotFoundException, UnsupportedEncodingException{
		super(file, TYPE, WATOR_TITLE, WATOR_AUTHOR, shape, gx, gy, cx, cy);
		prob_fish = probFish;
	...
	private void printWatorCell(String type, int i, int j, int rT, int gE, int e){
